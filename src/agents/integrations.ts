...
export class IntegrationsAgent {
  async generate(context: OrchestratorContext): Promise<{ files: GeneratedFile[] }> {
    logger.info('Integrations Agent: Generating third-party integrations');
  ...
  private generateStripeIntegration(): GeneratedFile[] {
    return [
      {
...
`,
  ...
  private generateSendGridIntegration(): GeneratedFile[] {
    return [
      {
...
`,
  ...
  private generateAWSIntegration(): GeneratedFile[] {
    return [
      {
...
`,
  ...
  private generateGitHubIntegration(): GeneratedFile[] {
    return [
      {
