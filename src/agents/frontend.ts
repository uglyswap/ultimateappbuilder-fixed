...
export class FrontendAgent {
  async generate(context: OrchestratorContext): Promise<{ files: GeneratedFile[] }> {
    logger.info('Frontend Agent: Generating React application');
...
`,
  ...
  private generateApp(context: OrchestratorContext): GeneratedFile {
    return {
...
`,
  ...
  private generateComponents(context: OrchestratorContext): GeneratedFile[] {
    const files: GeneratedFile[] = [];
