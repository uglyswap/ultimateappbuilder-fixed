...
export class AuthAgent {
  async generate(context: OrchestratorContext): Promise<{ files: GeneratedFile[] }> {
    logger.info('Auth Agent: Generating authentication system');
  ...
  private generateAuthRoutes(context: OrchestratorContext): GeneratedFile {
...
`,
  ...
  private generateAuthController(): GeneratedFile {
    return {
...
`,
  ...
  private generateAuthService(): GeneratedFile {
    return {
