...
export class DatabaseAgent {
  async generate(context: OrchestratorContext): Promise<{ files: GeneratedFile[] }> {
    logger.info('Database Agent: Generating database schema');
  ...
  private generatePrismaSchema(context: OrchestratorContext): GeneratedFile {
...
`;
  ...
  private generatePrismaClient(): GeneratedFile {
    return {
...
`,
  ...
  private generateSeedFile(context: OrchestratorContext): GeneratedFile {
