...
export class MicroservicesGeneratorService {
  /**
   * Generate microservices architecture
   */
  async generateMicroservices(services: MicroserviceConfig[]): Promise<{
    ...
    logger.info('Generating microservices architecture');
   ...
   */
  private async generateService(config: MicroserviceConfig): Promise<string> {
...
Generate the complete service code.`;
   ...
   * Generate API Gateway
   */
  private async generateAPIGateway(services: MicroserviceConfig[]): Promise<string> {
...
`;
   ...
   * Generate Docker Compose
   */
  private generateDockerCompose(services: MicroserviceConfig[]): string {
...
`;
   ...
   * Generate Kubernetes manifests
   */
  private generateKubernetesManifests(services: MicroserviceConfig[]): Record<string, string> {
...
`;
   ...
   * Generate message queue config
   */
  private generateMessageQueueConfig(services: MicroserviceConfig[]): string {
...
export const microservicesGeneratorService = new MicroservicesGeneratorService();
