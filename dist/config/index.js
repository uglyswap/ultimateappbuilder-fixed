...
function validateConfig() {
    const required = {
        'Database URL': exports.config.database.url,
    };
    ...
    const warnings = [];
    if (!exports.config.ai.apiKey && !exports.config.openai.apiKey && !exports.config.openrouter.apiKey) {
        warnings.push('No AI API keys configured. You can configure them via the /api/config endpoint after startup.');
    }
    if (exports.config.auth.jwtSecret === 'change-this-secret-key') {
