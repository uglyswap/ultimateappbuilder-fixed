...
exports.visualEditorService = exports.VisualEditorService = exports.COMPONENT_LIBRARY = void 0;
const client_1 = require("@prisma/client");
const logger_1 = require("../utils/logger");
const universal_ai_client_1 = require("../utils/universal-ai-client");
const prisma = new client_1.PrismaClient();
exports.COMPONENT_LIBRARY = {
    // ====================
    // Layout Components
    // ====================
    Container: {
...
class VisualEditorService {
     ...
     */
    async createDesign(projectId, pageName, route) {
        logger_1.logger.info(`Creating visual design for ${pageName} in project ${projectId}`);
        const design = {
            id: `design_${Date.now()}`,
            projectId,
            pageName,
     ...
     */
    async addComponent(designId, componentType, parentId, props) {
        const componentDef = exports.COMPONENT_LIBRARY[componentType];
        if (!componentDef) {
        ...
        logger_1.logger.info(`Added component ${componentType} to design ${designId}`);
        return component;
    }
    /**
     * Generate React code from visual design
     */
    async generateCodeFromDesign(design) {
        logger_1.logger.info(`Generating code for design: ${design.pageName}`);
...
Generate ONLY the component code, nothing else.`;
  ...
  meta: {
    ...
    generateComponentCode(component) {
        const template = exports.COMPONENT_LIBRARY[component.type]?.codeTemplate || '';
        let code = template;
    ...
    async saveDesign(design) {
        ...
        logger_1.logger.info(`Saved visual design ${design.id} to database`);
    }
    /**
     * Get component library
     */
    getComponentLibrary() {
        return exports.COMPONENT_LIBRARY;
    }
    /**
     * Get components by category
     */
    getComponentsByCategory(category) {
        return Object.entries(exports.COMPONENT_LIBRARY)
     ...
     */
    async generatePageFromDescription(projectId, pageName, description) {
        logger_1.logger.info(`Generating page ${pageName} from AI description`);
        const prompt = `You are a visual designer. Create a page design using the available components.

Page Name: ${pageName}
Description: ${description}

Available components: ${Object.keys(exports.COMPONENT_LIBRARY).join(', ')}
  ...
  "metadata": {
    ...
    "description": "Page description"
        ...
        try {
            ...
            logger_1.logger.error('Failed to parse AI-generated design', { error });
...
exports.VisualEditorService = VisualEditorService;
exports.visualEditorService = new VisualEditorService();
//# sourceMappingURL=visual-editor-service.js.map