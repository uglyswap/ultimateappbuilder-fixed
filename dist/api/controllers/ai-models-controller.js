...
exports.aiModelsController = exports.AIModelsController = void 0;
...
class AIModelsController {
    ...
    async getAllModels(req, res) {
        try {
            ...
            let models = universal_ai_client_1.UniversalAIClient.getAllModels(search);
            ...
            logger_1.logger.info('[AI Models] Retrieved models', {
                total: models.length,
                search,
                provider,
                minContext,
            ...
            logger_1.logger.error('[AI Models] Failed to get models', { error });
            res.status(500).json({
                success: false,
    ...
    async getProviders(req, res) {
        try {
            const allModels = universal_ai_client_1.UniversalAIClient.getAllModels();
            ...
            logger_1.logger.error('[AI Models] Failed to get providers', { error });
            res.status(500).json({
                success: false,
    ...
    async getRecommendedModels(req, res) {
        try {
            ...
            const modelIds = recommendations[useCase] || recommendations['code-generation'];
            const allModels = universal_ai_client_1.UniversalAIClient.getAllModels();
            ...
            logger_1.logger.error('[AI Models] Failed to get recommended models', { error });
            res.status(500).json({
                success: false,
...
exports.aiModelsController = new AIModelsController();
